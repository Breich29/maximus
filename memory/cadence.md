...
_Source: Granola meetings list (Apr 21 – May 21, 2026) + calendar inference_

---

## Confirmed Recurring

| Meeting | Frequency | Participants | Notes |
|---|---|---|---|
| Brandon / Taylor 1:1 | Weekly (inferred) | Brandon, Taylor McCurdy | Apr 21 instance confirmed |
...
|---|---|---|
| Brandon / Ashby 1:1 | Weekly | Brandon mentioned meeting Ashby "tomorrow" on May 19 and May 21 |
| Partner Metrics Review | Monthly or bi-weekly | Avery Miller frustrated about attendance (Tom, Matan, Sarah not present) |
| Recruitment kickoff / interview panels | Ad-hoc | Head of Partner Growth backfill — active now |
...
| Date | Event | Notes |
|---|---|---|
| ~May 23 | Get Palm exploratory meeting | Alex + Brandon |
| ~May 23 | Chris Elkins → vacation start (~2.5 weeks) | Brandon covers strategy |
| Week of May 26 | GustoPro stakeholder meetings | Bridgette, Lauren, Gowri |
| Jun 19 | NYC rehearsal dinner (personal) | Brandon in NYC for ~3 weeks in June |
| Jun 25 | NYC wedding (personal) | |
| Aug–Sep 2026 | Mid-desk renewal prep begins | 90-day notice needed by ~late July |
| ~Late Jul 2026 | Mid-desk 90-day notice window opens | Decide whether to notify intent to renegotiate |
| Nov 2026 | Mid-desk contract renewal | |
