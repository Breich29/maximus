...
- [ ] **New person detected — Mal Arun** (mal.arun@gusto.com): 1:1 with Brandon on the 7/17 calendar (10:15 AM). Zero prior context anywhere in memory or Granola. Add to map once role/context is known.
- [ ] **New person detected — Lars Wensel** (lars.wensel@zenbusiness.com): attendee on "Gusto | ZenBusiness Term Sheet Sync (Op Agrmt + Publication)," 7/17 11:00 AM. Not the previously known Zen Business contact (Farron Hicks owns that relationship product-side); no prior mention anywhere. Add to partners.md's Zen Business section / people.md external contacts once role is confirmed.
