...
- [ ] MSA template upgrades — no owner formally assigned yet. Brandon to loop in Allison Hess.
- [ ] Legal Link SLA renegotiation — no hard timeline. Brandon to be introduced first, then assess.
- [ ] GustoPro partnerships — currently no active partnerships. Brandon to assess landscape week of May 26.
