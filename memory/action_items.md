...
- [ ] **MidDesk 90-day renewal strategy** — Notice window closes ~Jul 28, 2026 (confirmed per DEC-007). Quinn call held 2026-07-14 (see Strategic Watch Items) — call went well; next step is following through on headless API co-build kickoff. — _Due: before Jul 28_
...
- [ ] **Post-Diomedes follow-up with Ben Stein (DoubleHQ)** — Jul 8 meeting happened (Ben Stein + ksong@doublehq.com). Jul 14 debrief confirmed buy-side lean (build vs. buy decision: Double is leading buy candidate). Define thesis and next steps. _(Supersedes "Message Ben Stein re: internal recap" — that window closed; meeting done)_
...
- [ ] **Chris Elkins + Jessica Sacks — standardize new-partner-integration process** — Chris proposed (Slack, 7/14 1:05 PM PT, thread on Quinn recap) building a standard approach for: (1) folding new eng teams into existing partner relationships (GBC staff needed Middesk API access; Paul Ort stepped in ad hoc while Jessica was OOO), (2) intake process for new biz use cases with existing partners (legal/compliance review of agreement + user-flow changes), (3) new cost-center/invoicing mapping when a legacy partner (Mid-desk/STR) picks up new use cases (GBC). No owner/timeline yet — the cost-center/invoicing piece is contract-adjacent and may want Brandon's input given his strategy/contracts scope. — _Due: unspecified, newly raised_
...
- [ ] Identify **Maggie** (Maggie Maroon per Jul 13 Quinn-prep notes — PM/product ops, valuable CX insights resource) — full Slack ID still needed.
...
- [ ] Identify **Delia** — **Name resolved: Delia He (delia.he@gusto.com)**, corp dev team. Confirmed Diomedes attendee Jul 8 and Jul 14. Slack ID still needed.
...
- [ ] Identify **Paul Ort** (Slack ID U07HA8DHNKC per 7/14 Chris Elkins message) — stepped in to help GBC team get Middesk API access while Jessica was OOO. Likely eng/partnerships adjacent — confirm role.
...
- [ ] **Diomedes** — codename for M&A exploration of **DoubleHQ** (practice management + month-end close for accounting firms; CEO Ben Stein). Pre-LOI diligence kicked off Jun 19. **Jul 14 debrief: strong consensus Double is more than an AI month-end-close tool — deeper practice management + highly iterated UX than expected; partnership model ruled out (must own practice management natively); Buy is the leading candidate over Build; phase one = Double handles data cleaning, accelerating Gusto Books for accountants.** Open: Abhas modeling integration-scope vs. build-from-scratch; Delia running a mini market scan (Puzzle + others) and looping in Brandon. Brandon is supporting/learning from the sideline with Ashby + Delia — not leading; do not assign Diomedes action items to Brandon unless he indicates otherwise. **Exception:** the Tomer-requested M&A thesis on DoubleHQ is a named deliverable that does sit with Brandon (see below) even inside the sideline framing.
...
- [ ] **New negotiation lever: invoice credits for SLA misses (Brandon, Slack, Jul 14, 1:32 PM PT)** — Floated as a "carrots and sticks" mechanism directly responding to Jessica's teeth ask above. Not yet developed into a formal proposal or run past Chris/Jessica for reaction. — _Due: unspecified, newly raised_
...
- [ ] MSA template upgrades — no owner formally assigned yet. Brandon to loop in Allison Hess (COM-003, due July).
- [ ] Legal Link SLA renegotiation — no binding SLA commitments in current contract; Becky Grant tracks metrics. Revisit renegotiation timing now that Mid-desk's Jul 28 window is the nearer-term priority.
- [ ] GustoPro partnerships (COM-009) — Jul 2/7 Anthropic pitch syncs ✅ (Brittany + Ashby aligned). Multi-auth MCP: 4–6 week bare MVP; #5 on H1 AI Interfaces. Active wildcard: "Claude for Small Business" — Ben Kagan pre-brief still OVERDUE (see Open Action Items above).

---

## Completed

- [x] **Quinn<>Brandon call** — Held 2026-07-14, 11:00 AM–12:00 PM PT. Strong outcome — see DEC-009, COM-015, COM-016. _(Completed Jul 14)_
- [x] **Debrief Diomedes** — Held 2026-07-14, 9:30–10:00 AM PT. Build-vs-buy leans Buy on DoubleHQ. _(Completed Jul 14)_
...
- [x] **M&A thesis on DoubleHQ → Tomer** — Bridgette Haymaker delivered [DRAFT] Double M&A Thesis to Notion overnight Jun 8. _(Delivered Jun 8 — confirmed in Jun 9 AM brief)_ _(Note: the separate, Brandon-owned M&A thesis deliverable tracked above under Strategic Watch Items appears to still be open as of Jul 14 — this earlier draft may be a precursor, not the same deliverable; not treating as resolved.)_
...
- [x] **COM-005 (MidDesk headless-API pre-flight ping)** — Jessica Sacks pre-flight call confirmed done; MidDesk meeting scheduled for ~Jun 12. Confirmed by Brandon Jun 4. _(Distinct from the currently-open GBC scribing/concierge-model COM-005 in commitments.md — see Needs Confirmation above.)_
