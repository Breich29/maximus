...
- **⚠️ Date-language discrepancy flagged 2026-07-17:** Slack #maximus-updates briefs (Jul 16–17) consistently describe the window as "opens Jul 24 (7 days out)," while DEC-007/this entry has it as "closes ~Jul 28" (confirmed 2026-07-13). These may be describing the same ~90-day notice mechanic from different ends (opens vs. closes) or may reflect a genuine date shift — not silently reconciled here. Needs Brandon's clarification on which date is the actual hard deadline.
- **POV status as of 2026-07-17 (COM-020):** Still not started. Flagged as the top-priority open item across every brief since Jul 13 — "if you do only one thing next week" line in the Jul 17 Friday Weekly Review. Chris/Jessica/Andrew are the intended reviewers once a first draft exists.
...
- **Next milestone:** Close by end of July 2026 (originally targeted for 2026-07-13, slipped due to DPA/economics decision). DPA received/approved (COM-013 done); next step is Allison Hess sending the 3-item counter-redlines back to Cindy (COM-022) — per the 2026-07-22 Night-Before Prep, this was due 2026-07-22 and flagged overdue if not sent that night.
